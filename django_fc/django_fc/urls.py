...
urlpatterns = [
    ...
    url(r"^fw_move_back/", views.fw_move_back, name="fw_move_back"),
    url(r"^fw_move_forward/", views.fw_move_forward, name="fw_move_forward"),
    url(r"^fw_move_to_start/", views.fw_move_to_start, name="fw_move_to_start"),
